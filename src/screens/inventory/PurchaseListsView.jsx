  ...
  return (
    <div className="h-full bg-rose-50 flex flex-col">
      <InventorySubscreenHeader
        title="Danh sách mua"
        subtitle="Những món cần nhập thêm"
        onBack={onBack}
      />
            ...
            {purchaseLists.map((list) => {
              ...
              return (
                <div
                  ...
                  className="rounded-[26px] border border-amber-100 bg-white shadow-sm px-5 py-4 active:scale-[0.99] transition-transform cursor-pointer"
                >

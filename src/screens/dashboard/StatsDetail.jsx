...
const StatsDetail = ({ products, orders, onBack, updateFab, isActive }) => {
  ...
  const comparisonStats = useMemo(() => {
    ...
    const calcStats = (rangeStartDate, rangeEndDate) => {
      // Tối ưu hóa: Sử dụng một vòng lặp for...of duy nhất thay vì filter() và nhiều reduce().
      // Điều này tránh việc tạo mảng trung gian và giảm số vòng lặp từ O(3N) xuống O(N).
      let revenue = 0;
      let profit = 0;
      let count = 0;

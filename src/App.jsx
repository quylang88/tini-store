    ...
    <div className="h-screen bg-gradient-to-br from-amber-50 via-rose-50 to-orange-100 text-gray-900 font-sans overflow-hidden flex flex-col">
      <div className="flex-1 overflow-hidden relative">
        <AnimatePresence mode="popLayout" initial={false} custom={direction}>
          {activeTab === 'dashboard' && (
            <ScreenTransition key="dashboard" custom={direction} className="h-full">
              <Dashboard
                products={products}
                orders={orders}
          ...
          {activeTab === 'products' && (
            <ScreenTransition key="products" custom={direction} className="h-full">
              <Inventory
                products={products}
          ...
          {activeTab === 'orders' && (
            <ScreenTransition key="orders" custom={direction} className="h-full">
              <Orders
                products={products}
                setProducts={setProducts}
                orders={orders}
          ...
          {activeTab === 'settings' && (
            <ScreenTransition key="settings" custom={direction} className="h-full">
              <Settings
                products={products}
                orders={orders}
                setProducts={setProducts}

        ...
        >
          {product.image ? (
            ...
            <div className="w-full h-full flex items-center justify-center text-gray-300">
              <ImageIcon size={20} className={isOutOfStock ? "text-gray-400" : ""} />
            </div>
          )}
        </div>
          ...
          <div className="flex justify-between items-start gap-2">
            <div
              className={`font-bold text-sm truncate ${
                isOutOfStock ? "text-gray-500" : "text-amber-900"
              }`}
            >
              {product.name}
            </div>
          ...
          <div className="flex justify-between items-baseline mt-1.5">
            <div
              className={`font-bold text-sm ${
                isOutOfStock ? "text-gray-500" : "text-rose-700"
              }`}
            >
            ...
            <div
              className={`text-[10px] font-medium text-right ${
                isOutOfStock ? "text-gray-400" : "text-amber-700"
              }`}
            >
              {activeWarehouse === "all" ? (
                <span>
        ...
        <div className="flex flex-col gap-2 self-center">
          <button
            ...
            className={`w-8 h-8 rounded-full flex items-center justify-center shadow-sm border ${
              isOutOfStock
                ? "bg-gray-200 text-gray-500 border-gray-300 active:bg-gray-300"
          ...
          <button
            ...
            className={`w-8 h-8 rounded-full flex items-center justify-center shadow-sm border ${
              isOutOfStock
                ? "bg-gray-200 text-gray-600 border-gray-300 active:bg-gray-300"

...
// Sử dụng React.memo để tối ưu hóa hiệu năng, tránh render lại danh sách tabs
// khi các props (tabs, activeTab) không thay đổi.
const AnimatedFilterTabs = memo(
  ({
    tabs,
    activeTab,
    onChange,
    ...
    className = "",
    tabClassName = "",
    activeColor = "bg-rose-500", // Default active background
    inactiveTextColor = "text-rose-700", // Default inactive text
    inactiveBorderColor = "border-rose-200", // Default inactive border
  }) => {

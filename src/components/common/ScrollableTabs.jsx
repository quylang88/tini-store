...
// khi component cha (ProductFilterHeader/Section) cập nhật state không liên quan (ví dụ: searchTerm).
// Điều này giúp giảm thiểu việc tính toán lại DOM và sự kiện cho danh sách tabs.

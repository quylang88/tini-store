...
const CustomCalendar = ({
  ...
  if (showMonthYearPicker) {
    ...
    return (
      <div className={`bg-white p-3 rounded-xl shadow-lg border border-amber-100 w-full ${className}`}>
        <div className="flex justify-between items-center mb-2 pb-2 border-b border-rose-100">
          <span className="text-sm font-bold text-rose-800">Chọn Tháng/Năm</span>
          <button
  ...
  return (
    <div className={`bg-white p-3 rounded-xl shadow-lg border border-amber-100 select-none ${className}`}>
      {/* Header */}
      <div className="flex items-center justify-between mb-3">
        <button onClick={handlePrevMonth} className="p-1 text-rose-500 hover:bg-rose-50 rounded-full">
          <ChevronLeft size={18} />
        </button>
        ...
        <button onClick={handleNextMonth} className="p-1 text-rose-500 hover:bg-rose-50 rounded-full">

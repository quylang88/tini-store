...
const ColorfulShopIcon = () => (
  ...
  >
    ...
    {/* Cửa chính */}
    <rect x="35" y="55" width="30" height="40" rx="2" fill="#FFE4E6" stroke="#FB7185" strokeWidth="2" />
    ...
    {/* Biển hiệu "SHOP" */}
    <rect x="35" y="5" width="30" height="12" rx="2" fill="#FBBF24" stroke="#D97706" strokeWidth="1" />
    <path d="M48 5V0M52 5V0" stroke="#78350F" strokeWidth="1" />

    {/* Cây cảnh trang trí 2 bên */}
    <circle cx="15" cy="90" r="8" fill="#4ADE80" stroke="#15803D" strokeWidth="1" />
    <path d="M15 90V95" stroke="#78350F" strokeWidth="2" />

    <circle cx="85" cy="90" r="8" fill="#4ADE80" stroke="#15803D" strokeWidth="1" />
      ...
      {!showWarning ? (
        ...
        >
          ...
          <p className="text-sm text-gray-600 mb-6 leading-relaxed">
            Hệ thống đang tải dữ liệu lâu hơn bình thường. Bạn có muốn vào ngay không?
          </p>

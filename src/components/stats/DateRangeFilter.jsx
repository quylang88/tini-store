...
// Ghi chú tổng quan:
// - Tách bộ lọc ngày ra component riêng để đơn giản hoá StatsDetail.
// - Dùng lịch tiếng Việt chọn khoảng ngày trên cùng một popup.
// - Có reset về tháng hiện tại, chọn nhanh theo tháng/năm và tự xoá lựa chọn còn lại.
// - Tự đóng lịch khi bấm ra ngoài để tránh che giao diện.

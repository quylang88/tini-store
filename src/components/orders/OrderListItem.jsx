...
const OrderListItem = memo(
  ({
    ...
    // Tối ưu hóa: Thay thế .reduce() bằng vòng lặp for...of để tính toán estimatedProfit,
    // giúp loại bỏ overhead khởi tạo callback và tăng tốc duyệt mảng (đặc biệt khi danh sách render nhiều đơn hàng).

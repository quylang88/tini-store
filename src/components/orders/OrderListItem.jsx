...
const OrderListItem = memo(
  ({
    ...
    // Tối ưu hoá tính toán: Sử dụng for...of thay cho Array.prototype.reduce()
    // Giảm chi phí cấp phát bộ nhớ cho callback, cải thiện thời gian render danh sách (component được gọi nhiều lần)

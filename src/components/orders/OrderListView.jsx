          ...
          >
            ...
            <div className="mt-3 flex flex-wrap justify-end gap-2">
              <button
                ...
                className={`text-xs font-semibold px-3 py-1.5 rounded-full border transition active:scale-95 ${isPaid ? 'text-red-600 bg-red-50 border-red-100' : 'text-emerald-600 bg-emerald-50 border-emerald-100'}`}
              >

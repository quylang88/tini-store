    ...
    <div className="flex flex-col h-full bg-transparent pb-safe-area relative">
      ...
      {!isReviewOpen && !hideBackButton && totalAmount <= 0 && (
        <FloatingBackButton
          ...
          className={totalAmount > 0 ? 'bottom-[calc(env(safe-area-inset-bottom)+140px)]' : 'bottom-[calc(env(safe-area-inset-bottom)+20px)]'}
        />
      )}
      ...
      >
        <div className="space-y-4">
          <div className="text-xs text-amber-600 -mt-2 mb-2">Kiểm tra lại danh sách sản phẩm trước khi xác nhận.</div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 px-3 py-2 rounded-lg text-xs font-semibold border transition ${orderType === 'delivery'
              ...
              <button
                ...
                className={`flex-1 px-3 py-2 rounded-lg text-xs font-semibold border transition ${orderType === 'warehouse'
                    ? 'bg-amber-500 text-white border-amber-500'
                    : 'bg-amber-50 text-amber-700 border-amber-200'
                  }`}
              >

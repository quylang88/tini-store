...
const useCustomerLogic = ({ customers, setCustomers }) => {
  // Hook này giờ đây nhận state từ bên ngoài (App.jsx -> Orders.jsx -> ...)
  // Không còn tự quản lý state hay localStorage nữa.

  const processOrderForCustomer = useCallback(
    (order, isUpdate = false) => {
      ...
      setCustomers((currentCustomers) => {
        ...
        // Việc lưu xuống DB sẽ do useEffect ở App.jsx đảm nhiệm khi state thay đổi
